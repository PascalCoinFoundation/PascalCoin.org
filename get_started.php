...
<title>PascalCoin.com | Get Started</title>
    ...
    <div id="whatis" class="content-section-b" style="border-top: 0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12 wow fadeInDown text-center get_started1">
                        ...
                        <div class="col-sm-12 wow fadeInDown text-center get_started2">
                            <div class="single-feature">
                                <div class="get_started_icon">
                        ...
                        <div class="col-sm-12 wow fadeInDown text-center get_started3">
                            <div class="single-feature">
                                <div class="get_started_icon">
                        ...
                        <div class="col-sm-12 wow fadeInDown text-center get_started4">
                            <div class="single-feature">
                                <div class="get_started_icon">
                        ...
                        <div class="col-sm-12 wow fadeInDown text-center get_started5">
                            <div class="single-feature">
                                <div class="get_started_icon">
