        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h3 class="breadcrumb-title">@dt($dtGroup, 'page_title', 'How to mine PascalCoin')</h3>
                    <ol class="breadcrumb">
                        <li><a href="#">@dt($dtGroup, 'bc_home', 'Home')</a></li>
                        <li class="active">@dt($dtGroup, 'bc_page', 'How to mine PascalCoin')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="abouthead">
                    ...
                    <p>@dt($dtGroup, 'page_teaser', 'A brief introduction on how to setup and start mining.')</p>
